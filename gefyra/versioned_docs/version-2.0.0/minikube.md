...
2. Gefyra is [available](https://gefyra.dev/installation) (at least in version 2.0.0kub)
...
```sh
gefyra bridge -N mypyserver -n default --ports 8000:80 --target deploy/hello-nginxdemo/hello-nginx
``` 
